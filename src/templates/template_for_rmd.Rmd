...
dir_git     <- here()
dir_spatial <- here('prep/spatial')  ### github: general buffer region shapefiles
dir_anx     <- file.path(dir_M, 'git-annex/bcprep')

### goal specific folders and info
goal      <- 'GOALNAME'
scenario  <- 'v2016'
dir_goal  <- here('prep', goal, scenario)
...
### support scripts
source(here('src/R/map_scores.R'))
  ### score plotting scripts
source(here('src/R/rast_tools.R')) 
