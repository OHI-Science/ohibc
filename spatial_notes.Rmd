...
* `SpatialPolygonsDataFrame` (top level structure)
    ...
    * `polygons`: a list of SpatialPolygons-class objects, each with their own bits and pieces.  Each item in the list is a polygon, made up of sub-polygons; and each item in the list corresponds with a row in the dataframe in the `data` slot.
