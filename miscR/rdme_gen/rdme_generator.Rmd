...
for(i in seq_along(readme_df$dir)) {
  ...
  readr::write_file(readme_text, file.path(readme_df$dir[i], 'README_test.md'))
  
}

# x <- list.files(dir_git, recursive = TRUE, pattern = 'readme_test.md', full.names = TRUE, ignore.case = TRUE)
# unlink(x)
```
