...
Once you get your ggplot code all worked out, assign it to a named object, and then use `print(object_name)`.  Just calling `object_name` works within a regular R script, but not when knitting.
