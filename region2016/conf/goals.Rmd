...
$$
Y_{c} = \frac{\displaystyle\sum Y_{k} * S_{M,k}}{P_{c}}
$$
...
$$
x_{NP} = \frac{\displaystyle\sum w_p * x_p}{N}  
$$
...
$$
x_{CS} =  \displaystyle\sum \frac{C_{s}}{C_{r}} * \frac{A_{k}}{A_{T}}
$$
...
$$
x_{CP} =  \displaystyle\sum \alpha_{k} * \frac{C_{c,k}}{C_{r,k}}
$$

$$
\alpha_{k} = \frac{w_{k}*A_{k}}{\displaystyle\sum{w_{k}*A_{k}}}
$$

$$
w_{k} = \frac{r_{k}}{\displaystyle\sum{r_{k}}}
$$
...
$$
x_{LIV} = \frac{\frac{\displaystyle\sum j_{c,k}}{\displaystyle\sum j_{r,k}} + \frac{\displaystyle\sum g_{m,k}}{\displaystyle\sum g_{r,k}}}{2}
$$
...
$$
x_{ECO} = \displaystyle\sum_{i=1}^{k} \frac{e_{c,k}}{e_{r,k}} 
$$
...
$$
x_{ICO} = \frac{\displaystyle\sum S_{i} * w_{i}}{\displaystyle\sum S_{i}} 
$$
...
$$
x_{HAB} =  \displaystyle\sum_{i=1}^{k} \frac{C_{c,k}}{C_{r,k}} * \frac{A_{c,k}}{A_{T}}
$$
...
$$
x_{SPP} = \frac{\displaystyle\sum_{k=1}^{M} \left(\displaystyle\sum_{i=1}^{N} w_{i} / N\right) * A_{C}}{A_{T}} 
$$
