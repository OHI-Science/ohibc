...
Each cell will be rescaled to a 0-1 score based on the reference point of 50% of weeks being anomalous.  Note for 2016, we have to account for two missing weeks, so we multiply the proportion of anomalous weeks by $\frac{26}{25}$.
