...
This is identical to the HAB soft bottom trawl component layer.  For bookkeeping we will just copy it over to the _pressures/v2017/output folder.
...
file.copy(orig, dst, overwrite = TRUE)

git_prov(orig, filetype = 'input')
git_prov(dst, filetype = 'output')
