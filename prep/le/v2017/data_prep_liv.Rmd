...
write_csv(income_wt_mean, file.path(dir_goal, 'output', 'liv_income.csv'))
...
write_csv(unempl_layer, file.path(dir_goal, 'output', 'liv_unemployment.csv'))
...
income_layer <- read_csv(file.path(dir_goal, 'output', 'liv_income.csv')) %>%
  left_join(get_rgn_names(), by = 'rgn_id')
unempl_layer <- read_csv(file.path(dir_goal, 'output', 'liv_unemployment.csv')) %>%
  left_join(get_rgn_names(), by = 'rgn_id')
