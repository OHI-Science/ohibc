...
# write_csv(fn_pop_income, file.path(dir_goal, 'int', 'le_pop_income_fn.csv'))
# write_csv(non_fn_pop_income, file.path(dir_goal, 'int', 'le_pop_income_nonfn.csv'))
...
# write_csv(fn_pop_unempl,     file.path(dir_goal, 'int', 'le_pop_unempl_fn.csv'))
# write_csv(non_fn_pop_unempl, file.path(dir_goal, 'int', 'le_pop_unempl_nonfn.csv'))
...
write_csv(ref_pts_low_allyrs, file.path(dir_goal, 'output/le_income_lower_ref.csv'))
...
write_csv(ref_pts_low_allyrs, file.path(dir_goal, 'output/le_unempl_upper_ref.csv'))
...
income_ref <- read_csv(file.path(dir_goal, 'output', 'le_income_lower_ref.csv')) %>%
  left_join(get_rgn_names(), by = 'rgn_id')
...
unempl_ref <- read_csv(file.path(dir_goal, 'output', 'le_unempl_upper_ref.csv')) %>%
  left_join(get_rgn_names(), by = 'rgn_id')
