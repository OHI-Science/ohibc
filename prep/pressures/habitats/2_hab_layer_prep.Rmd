...
if(!any(file.exists(rast_hard_shallow_file,
  ...
  values(rast_hard_shallow)[!is.na(values(rast_hard_shallow))] <- 99 # hab_lyrs$layer_id[hab_lyrs$category == 'shallow hard bottom'] ### no place for this
...
rast_hydro_vent_file <- file.path(dir_rast, 'hab_hydrothermal_vents.tif')
