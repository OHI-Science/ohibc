...
this_script_file <- file.path(dir_goal, 'pressures_oa_prep.Rmd') 
...
git_prov(file.path(oa_data_dir, 'input/cesm_co2sys_1880-1889.nc'), type = 'input')
# print(data_nc_18)

### read in 2005-2014 data
data_nc_20 = nc_open(file.path(oa_data_dir, 'input/cesm_co2sys_2005-2014.nc'))
git_prov(file.path(oa_data_dir, 'input/cesm_co2sys_2005-2014.nc'), type = 'input')
# print(data_nc_20)
