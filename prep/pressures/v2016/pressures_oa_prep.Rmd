...
use 1000 m region ID raster to run zonal statistics on the pressures layers (within brick or separately?) and save as an output .csv.

``` {r calc_mean_pressures}

oa_rgn_mean <- zonal(rbrick, rast_rgn, fun = 'mean') 

knitr::kable(oa_rgn_mean)
