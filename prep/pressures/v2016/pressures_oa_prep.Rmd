...
oa_raster_file <- c(file.path(dir_goal, 'data/oa/oa_rescaled_2005-2014_1000pts.tif'))
...
if(!file.exists(oa_raster_file) | reload) {
  ...
  oa_rescaled_int <- interpolate_brick(oa_rescaled, subset_n = 1000)
...
write_csv(oa_rgn_mean_df, file.path(dir_goal, 'data/oa/oa_rgn_pressures.csv'))
```
