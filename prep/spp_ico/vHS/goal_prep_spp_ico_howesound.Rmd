...
DT::datatable(spp_table_info, caption = 'Howe Sound species list')
...
spp_status_ts <- spp_risk_ts %>%
  mutate(status = (.75 - mean_cat_ts)/.75)
...
ico_list <- read_csv(file.path(dir_goal, 'ico_list_howe_sound.csv')) %>%
...
DT::datatable(ico_table_info, caption = 'Howe Sound iconic species list')
