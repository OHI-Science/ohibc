...
git_prov(file.path(dir_spp, 'R/spp_fxn.R'), prov_type = 'sourced_script')
...
DT::datatable(spp_all %>% 
                select(sciname, am_sid, iucn_sid, popn_trend, IUCN_cat = popn_category, NS_cat = status_pr, spatial_source),
              rownames = FALSE,
...
am_cells_spp <- spp_get_am_cells(rgn2cell_df, n_max = -1, prob_filter = 0, reload = TRUE)
...
git_prov(file.path(dir_git, scenario, 'data/spp_status_3nm.csv'), prov_type = 'output')
git_prov(file.path(dir_git, scenario, 'data/spp_trend_3nm.csv'),  prov_type = 'output')
