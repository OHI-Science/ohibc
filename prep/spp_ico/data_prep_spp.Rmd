...
git_prov(file.path(dir_git, scenario, 'int/spp_all.csv'), type = 'output')
...
git_prov(file.path(dir_git, scenario, 'data/spp_status.csv'), type = 'output')
git_prov(file.path(dir_git, scenario, 'data/spp_trend.csv'),  type = 'output')
...
git_prov(file.path(dir_git, scenario, 'data/spp_status_3nm.csv'), type = 'output')
git_prov(file.path(dir_git, scenario, 'data/spp_trend_3nm.csv'),  type = 'output')
