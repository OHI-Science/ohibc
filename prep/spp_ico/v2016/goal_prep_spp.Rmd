...
iucn_cells_sum <- spp_iucn_cell_summary(spp_all, iucn_cells_spp, fn_tag = '', reload = TRUE)
...
``` {r spp plot species count raster, cache = TRUE, fig.height = 4, fig.width = 6, fig.align = 'center'}
...
sum_by_cell <- spp_calc_cell_means(am_cells_sum, iucn_cells_sum, fn_tag = '')

sum_by_rgn  <- spp_calc_rgn_means(sum_by_cell, rgn2cell_df, rgn_tag = '')
