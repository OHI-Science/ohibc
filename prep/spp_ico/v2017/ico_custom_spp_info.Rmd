...
am_sid,iucn_sid,sciname,spp_group,map_iucn_sid,map_subpop,pr_score,spatial_source,risk_trend,cat_ts,cat_ts_score,assess_year,year

spp_cat_trend_df <- spp_cat_trend_df %>%
  mutate(am_sid = NA,
...
write_csv(spp_cat_trend_df, file.path(dir_goal, 'int/spp_custom_scored.csv'))
