...
poly_ebsa_trim <- poly_ebsa[!(is.na(poly_ebsa@data$phys) & is.na(poly_ebsa@data$agg)), ]
...
### combine both into one big spatialpolygonsdataframe
poly_ebsa_hab <- rbind(poly_ebsa_trim, poly_sg_sponges)

### save locally for next step: rasterization
writeOGR(poly_ebsa_hab)
