...
* 99.99%ile within BC EEZ:  `r trash_ref_9999qtile` g/km^2^ (log(x+1) = `r trash_logref_9999qtile`)
...
* 110% of max within BC EEZ:  `r trash_ref_110max` g/km^2^  (log(x+1) = `r trash_logref_110max`)
...
* 99.99%ile within NE Pacific:  `r trash_ref_9999qtile_npac` g/km^2^  (log(x+1) = `r trash_logref_9999qtile_npac`)
