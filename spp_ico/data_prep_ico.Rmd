...
The Status of this sub-goal (X~ICO~) is therefore simply the % of iconic species in each threat category (as defined by the IUCN Red List), such that:
...
ICO trend is calculated in a similar manner, but weightings are assigned according to population trend: 'Decreasing' = -0.5, 'Stable' = 0.0, 'Increasing' = +0.5
...
<<<<<<< HEAD:spp_ico/data_prep_ICO.Rmd
### clean up names
=======
# clean up names
>>>>>>> 6edb601ff0b48142f56c53f2467909cfb9bc4c0e:spp_ico/data_prep_ico.Rmd
...
<<<<<<< HEAD:spp_ico/data_prep_ICO.Rmd
git_prov(file.path(dir_git, scenario, 'int/spp_all_bcsee.csv')
=======
git_prov(file.path(dir_git, scenario, 'int/spp_all_bcsee.csv'))
>>>>>>> 6edb601ff0b48142f56c53f2467909cfb9bc4c0e:spp_ico/data_prep_ico.Rmd
...
message(sprintf('Writing ICO status and trend to:\n  %s\n  %s\n', 
...
git_prov(file.path(dir_git, scenario, 'data/ico_status.csv'), prov_type = 'output')
write_csv(ico_trend,  file.path(dir_git, scenario, 'data/ico_trend.csv'))
git_prov(file.path(dir_git, scenario, 'data/ico_trend.csv'), prov_type = 'output')

```

## Compare status and trend by region

``` {r Compare status and trend, echo = FALSE, message = FALSE, cache = TRUE, fig.height = 4, fig.width = 6, fig.align = 'center'}
