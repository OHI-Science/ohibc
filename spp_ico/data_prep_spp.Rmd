...
``` {r plot regions raster, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE, cache = TRUE}
...
``` {r plot species count raster, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE, cache = TRUE}
...
spp_plot_raster(cells_sum, loiczid_rast, 'n_cat', poly_bc_rgn)

```

### Summarize mean category and trend per cell and per region

``` {r summing by cells and rgn, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE}
...
#### Map of mean category value by cell

*Category value range: least concern = 0, extinct = 1*
``` {r plot cell score raster, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE, cache = TRUE}

spp_plot_raster(as.data.frame(summary_by_loiczid), loiczid_rast, 'weighted_mean_cat', poly_bc_rgn)
...
``` {r calc 3nm SPP values, eval = TRUE, echo = TRUE, message = FALSE}
...
rgn2cell_3nm_df <- spp_rgn2cell(poly_bc_3nm, reload  = TRUE)[[1]]
