...
#                                    color = 'grey40',
#                                    family = 'Helvetica'))
# ggsave(filename = file.path(dir_scenario, 'howe_sound_flower_mod.png'),
